  ...
  return (
    <Layout>
      ...
      <main className="w-full">
        <h1 style={{textAlign: 'left'}}><strong>Faites d&eacute;coller vos projets avec Marie Ollier</strong></h1>
        <h2 style={{textAlign: 'center'}}><strong>Vous cherchez un <a href="https://www.marieollier.com/graphiste-illustratrice-bordeaux/">graphiste &agrave; Bordeaux</a>&nbsp;qui puisse vous offrir des prestations de qualit&eacute; ?&nbsp;</strong></h2>
        ...
        <p style={{textAlign: 'center'}}><strong>Offrez vous la cr&eacute;ativit&eacute; sans limite de Marie Ollier</strong></p>
